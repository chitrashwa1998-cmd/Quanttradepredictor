...
try:
    if st.session_state.current_page == "home":
        ...
        # Handle unknown page states
        st.error(f"⚠️ Unknown page: {st.session_state.current_page}")
        st.info("Redirecting to home page...")
        st.session_state.current_page = "home"
        st.rerun()

except Exception as page_error:
    # Fallback to home page if any page rendering fails
    st.error("⚠️ Page loading error. Redirecting to home page...")
    st.session_state.current_page = "home"
    st.rerun()